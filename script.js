...
function generateVibe(){
    ...
    const vibeArray = ["Black", "White", "Black and White", "Red", "Green", "Blue", "Yellow", "Orange", "Purple", "Pink", "Brown", "Grey", "Super Heroes", "Star Wars", "Anime", "Fantasy", "High School Superlatives", "Animal Friends", "Tough Guy", "Sports", "Food", "Samurai", "My Squad", "Robot", "Alien", "Saturday Night Fever?"]
