...
function generateVibe(){
    ...
    const vibeArray = ["Black", "White", "Black and White", "Red", "Green", "Blue", "Yellow", "Orange", "Purple", "Pink", "Brown", "Grey", "SuperHeroes", "Star Wars", "Anime", "Fantasy", "High School Superlatives", "Animal Friends"]
